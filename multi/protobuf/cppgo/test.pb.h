...
PROTOBUF_NAMESPACE_OPEN
template<> ::test::helloworld* Arena::CreateMaybeMessage<::test::helloworld>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace test {
...
class helloworld final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:test.helloworld) */ {
 public:
...
inline const std::string& helloworld::str() const {
  // @@protoc_insertion_point(field_get:test.helloworld.str)
...
void helloworld::set_str(ArgT0&& arg0, ArgT... args) {
 ...
 str_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:test.helloworld.str)
}
inline std::string* helloworld::mutable_str() {
  std::string* _s = _internal_mutable_str();
  // @@protoc_insertion_point(field_mutable:test.helloworld.str)
  return _s;
}
...
inline std::string* helloworld::release_str() {
  // @@protoc_insertion_point(field_release:test.helloworld.str)
...
inline void helloworld::set_allocated_str(std::string* str) {
  ...
  // @@protoc_insertion_point(field_set_allocated:test.helloworld.str)
}

// optional int32 wow = 3;
inline bool helloworld::_internal_has_wow() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool helloworld::has_wow() const {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 helloworld::_internal_wow() const {
  return wow_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 helloworld::wow() const {
  // @@protoc_insertion_point(field_get:test.helloworld.wow)
  return _internal_wow();
}
inline void helloworld::_internal_set_wow(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  wow_ = value;
}
inline void helloworld::set_wow(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_wow(value);
  // @@protoc_insertion_point(field_set:test.helloworld.wow)
}
