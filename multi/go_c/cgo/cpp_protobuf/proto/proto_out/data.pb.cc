...
namespace data {
constexpr InData::InData(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : str_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , id_(0)
  , wow_(0){}
struct InDataDefaultTypeInternal {
  constexpr InDataDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~InDataDefaultTypeInternal() {}
  union {
    InData _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT InDataDefaultTypeInternal _InData_default_instance_;
}  // namespace data
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_data_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::data::InData, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::data::InData, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::data::InData, id_),
  PROTOBUF_FIELD_OFFSET(::data::InData, str_),
  PROTOBUF_FIELD_OFFSET(::data::InData, wow_),
  1,
  0,
  2,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::data::InData)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::data::_InData_default_instance_),
};

const char descriptor_table_protodef_data_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ndata.proto\022\004data\".\n\006InData\022\n\n\002id\030\001 \002(\005"
  "\022\013\n\003str\030\002 \002(\t\022\013\n\003wow\030\003 \001(\005"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_data_2eproto = {
  false, false, 66, descriptor_table_protodef_data_2eproto, "data.proto", 
...
class InData::_Internal {
 public:
  ...
  static void set_has_wow(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
...
InData::InData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:data.InData)
}
InData::InData(const InData& from)
  ...
  ::memcpy(&id_, &from.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&wow_) -
    reinterpret_cast<char*>(&id_)) + sizeof(wow_));
  // @@protoc_insertion_point(copy_constructor:data.InData)
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&wow_) -
    reinterpret_cast<char*>(&id_)) + sizeof(wow_));
}

InData::~InData() {
  // @@protoc_insertion_point(destructor:data.InData)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void InData::SharedDtor() {
...
void InData::Clear() {
// @@protoc_insertion_point(message_clear_start:data.InData)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "data.InData.str");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          _Internal::set_has_wow(&has_bits);
          wow_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* InData::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:data.InData)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_wow(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:data.InData)
  return target;
}

size_t InData::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:data.InData)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:data.InData)
  size_t total_size = 0;
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000004u) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_wow());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_cached_size_);
}

const ::PROTOBUF_NAMESPACE_ID::Message::ClassData InData::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    InData::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*InData::GetClassData() const { return &_class_data_; }

void InData::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<InData *>(to)->MergeFrom(
      static_cast<const InData &>(from));
}


void InData::MergeFrom(const InData& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:data.InData)
...
// @@protoc_insertion_point(class_specific_copy_from_start:data.InData)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void InData::InternalSwap(InData* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(InData, wow_)
      + sizeof(InData::wow_)
      - PROTOBUF_FIELD_OFFSET(InData, id_)>(
...
template<> PROTOBUF_NOINLINE ::data::InData* Arena::CreateMaybeMessage< ::data::InData >(Arena* arena) {
  return Arena::CreateMessageInternal< ::data::InData >(arena);
}
